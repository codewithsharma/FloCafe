...
function FindingRow({ finding }: { finding: HealthFinding }) {
  return (
    <div className="rounded-lg border border-flo-border p-3 text-sm">
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          {finding.suggestedDdl && (
            <code className="block mt-2 rounded bg-flo-bg px-2 py-1 text-xs text-flo-text-secondary overflow-x-auto">
              {finding.suggestedDdl}
            </code>
          )}
        </div>
