...
**Next (2.9+):** deepen remaining coupling (product CRUD → ledger, tax HTTP consolidation) or documented fail-closed design after pilot proof — still no package extraction.
