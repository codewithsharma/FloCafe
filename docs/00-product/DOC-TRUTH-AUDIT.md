...
**App version at audit:** 3.0.5 (`flo-desktop`) / productName `Operavia`  
...
| ------------------------------------------------------------------------ | -------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `.env.example`                                                           | Missing `ACTIVE_VERTICAL_ID` and other consumed env vars; FloCafe branding | Documented `ACTIVE_VERTICAL_ID` (restaurant\|retail\|retail-test), defaults, fail-closed warning; added `SERVER_APP_PORT`, `LOG_LEVEL`, `FLO_ALLOW_JWT_SECRET_ENV`; Operavia branding |
...
| `README.md`                                                              | Product name FloCafe; false Bluetooth claim                                | Operavia product naming; naming note for flo\* IDs; Bluetooth corrected; shifts/refunds called out; Retail env note                                                                   |
| `CHANGELOG.md`                                                           | No Phase 3 / vertical notes; Flo Cafe title                                | `[Unreleased]` entry; Operavia title with legacy note                                                                                                                                 |
...
| `CONTRIBUTING.md`                                                        | FloCafe as product name                                                    | Operavia product; FloCafe as repo name                                                                                                                                                |
| `STRATEGY.md`                                                            | Listed Retail under Future PLANNED only                                    | Clarified Retail composition vs other PLANNED verticals                                                                                                                               |
| `docs/00-product/problem-statement.md`                                   | Claimed no shifts/refunds                                                  | Corrected limitations; Operavia branding                                                                                                                                              |
| `docs/00-product/PRD.md` / `goals-and-objectives.md` / `target-users.md` | FloCafe CURRENT; TARGET listed built features as future                    | Aligned to Operavia + built vs planned                                                                                                                                                |
| `docs/16-release/production-readiness.md`                                | Current product Operavia POS                                               | Operavia Restaurant                                                                                                                                                                   |
| `docs/google-drive-setup.md`                                             | FloCafe product name                                                       | Operavia                                                                                                                                                                              |
...
README.md: Replaced FloCafe product-name instances with Operavia. Kept FloCafe/flo* as repo/package identifiers with clarifying note. Fixed Bluetooth claim. FloPOS Reddit URL left (live community link).
...
- AppX `displayName: Operavia` in package.json build block (code/config, not doc)
- Dual brand in store listings vs Operavia product name may confuse merchants until store metadata is updated
