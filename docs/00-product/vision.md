...
A **mature local-first café POS with KDS and operational management capabilities** — Electron desktop, SQLite, offline billing. Evidence: `package.json` (`productName: Operavia`), `main/index.ts`, schema **v80**, `STRATEGY.md`.
...
- Version: `package.json` `"version": "3.0.5"` · schema **v80** in `main/db.ts`
