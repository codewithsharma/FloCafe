...
| SR-C-09 | Business audit log for auth/staff/void actions | audit-log.test.ts |
...
| SR-T-05 | Audit log for payment/refund/void actions | P1 — **partial** (M3: auth/staff/void; M7: full void; M5: refunds) |
