...
**Product:** Operavia POS (`flo-desktop`)  
...
| Build timestamp (local training pack) | Info.plist / app mtime ~ **2026-08-13** (local `release/mac-arm64/Operavia.app`)                                                                                                 | TRAINING/QA ONLY          |
| Platform (this audit host)            | macOS arm64                                                                                                                                                                      | Recorded                  |
| Artifact (local)                      | `release/mac-arm64/Operavia.app` — **adhoc / linker-signed**, TeamIdentifier not set, **not notarized**                                                                          | TRAINING/QA ONLY          |
...
| B6  | Isolated training smoke (optional engineering) | **PASS** | `$HOME/Operavia-p1-6-fresh-smoke`; flo-desktop Local State untouched; see `p1.6-pilot-release-readiness.md` |
...
| D2  | DB loss → marker retained    | **PASS** (P1.5 DR) | Isolated UD `$HOME/Operavia-p1-5-dr-final`            |
