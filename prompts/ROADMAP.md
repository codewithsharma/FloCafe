...
| ----: | ---------------------------------------------- | ------------------------------------ | ---------------------------- | ------------------------------ | ---------------------------------- | ---------- |
|   4.6 | ADR-013 Retail product variants / SKU identity | Retail (shared catalog identity)     | Medium (policy)              | NO now (ADR may require later) | NO                                 | **ACTIVE** |
|   4.7 | Restaurant 86 (sold-out) workflow              | Restaurant first; shared `is_active` | Low                          | NO                             | NO                                 | PENDING    |
|   4.8 | Reports multi-day range picker                 | Shared                               | Low                          | NO                             | Read-only                          | PENDING    |
|   4.9 | Customer deactivate lifecycle                  | Shared                               | Low                          | NO                             | NO                                 | PENDING    |
|  4.10 | FIN-01 collectible outstanding display         | Shared                               | Medium (money UX)            | NO                             | Display only — no writes           | PENDING    |
