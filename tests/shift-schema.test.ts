...
async function main() {
  ...
  assert.equal(latestMigration.name, 'r13_print_jobs');
  ...
  assert.equal(db.pragma('user_version', { simple: true }), 86);
  ...
  assert.equal(upgradedFrom68.pragma('user_version', { simple: true }), 86);
  ...
  assert.equal(upgradedFrom69.pragma('user_version', { simple: true }), 86);
  ...
  assert.equal(reopened.pragma('user_version', { simple: true }), 86);
  ...
  assert.equal(idealDb.pragma('user_version', { simple: true }), 86);
  assert.ok(
