...
- [ ] **Authorized next:** R9 Slice 6 food-cost report — R9 program governance; theoretical COGS only (no R12 actual-vs-theoretical BI). Or OPS-02 signed RC when credentials available.
