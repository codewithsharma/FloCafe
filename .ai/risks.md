...
- ⚠️ RISK: **Full `npm run lint`** remains red on pre-existing frontend React Compiler rules (`set-state-in-effect`, `refs` in `useKdsConnection.ts`, recipes/QR/TableQrDialog, etc.) — baseline debt; do not conflate with P6–P10.
