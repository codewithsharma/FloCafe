...
- ⚠️ RISK: Inventory valuation (4.11) is **catalog cost × on-hand**, not WAC/FIFO/COGS. Stale `products.cost` misleads owners — copy discloses this; do not invent a costing engine.
