...
| **Phase 4** | **4.1–4.4 COMPLETE** (4.4 accounting CSV export). Do not start P1.6 eng work. |
...
**Phase 4.4 COMPLETE** — accounting CSV export (`docs/04-product/phase-4.4-accounting-csv.md`). Next: Phase 4 backlog / pilot ops. Do **not** reopen 3.5B / 3.5C / REAL→cents / P1.6.
