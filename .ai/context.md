...
| **Phase 4** | **4.1–4.3 COMPLETE** (floor usability; refund restock ADR-011; low-stock attention hub). Do not start P1.6 eng work. |
...
**Phase 4.3 COMPLETE.** Next SAFE candidate: accounting CSV export. Do **not** reopen 3.5B / 3.5C / REAL→cents / P1.6.
