...
| **Phase 4** | **4.1–4.5 COMPLETE** (Retail exchange v1). Do not start P1.6 eng work. |
...
**Phase 4.5 COMPLETE** — Retail exchange (`docs/04-product/phase-4.5-retail-exchange.md`). Do **not** reopen 3.5B / 3.5C / REAL→cents / P1.6.
