...
| **Phase 4** | **4.1–4.5 COMPLETE**; **4.6 ADR-013 Accepted** (identity lock; no matrix). **4.7 Restaurant 86 COMPLETE**. Do not start 4.8+ or P1.6 eng work. |
...
**Phase 4.7 Restaurant 86 COMPLETE.** ADR-013 Accepted (Option A identity; matrix not authorized). Do **not** start 4.8. Do **not** implement a variants matrix. Do **not** reopen 3.5B / 3.5C / REAL→cents / P1.6.
