...
**P1.6 pilot gates / first supervised café.** Phase 3.1–3.4 COMPLETE; 3.5A ledger UI COMPLETE; **3.5B DEFERRED** until pilot evidence (no Mode B/DROP). Do not start another Phase 3.5 feature unless explicitly authorized. Human gates still block go-live: signed/notarized artifact, Master PIN escrow, OPS-01 on-site, backup policy approval, CEO/CTO sign-off.
