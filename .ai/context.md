...
| **Phase 4** | **4.1–4.5 COMPLETE**; **4.6 ADR-013 Proposed** (human Accept). Pipeline `prompts/` — **STOP auto-advance**. Do not start P1.6 eng work. |
...
**Phase 4.6 ADR-013 drafted — Proposed.** Human Accept required. Do **not** implement a variants matrix. Do **not** auto-start 4.7. Doc: `docs/14-decisions/ADR-013-retail-product-variants-sku-identity.md`. Do **not** reopen 3.5B / 3.5C / REAL→cents / P1.6.
