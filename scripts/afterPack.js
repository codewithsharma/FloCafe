...
module.exports = async function afterPack(context) {
  ...
  if (packager.platform.name === 'linux') {
    const metainfoSrc = path.join(packager.projectDir, 'assets/com.operavia.desktop.metainfo.xml');
    const metainfoDest = path.join(appOutDir, 'share/metainfo/com.operavia.desktop.metainfo.xml');
