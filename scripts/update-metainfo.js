#!/usr/bin/env node
// Prepends a <release> entry to assets/com.operavia.desktop.metainfo.xml at release
...
const META_FILE = path.join(ROOT, 'assets/com.operavia.desktop.metainfo.xml');
